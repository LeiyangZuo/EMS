        ...
        <ul>
            ...
            <li class="active has-sub">
                ...
                <ul class="sub">
                    ...
                    <li class="active"><a href="StudentManagementServlet?action=list">管理学生</a></li>
                </ul>
          </li>
            <li class="has-sub">
                <a href="javascript:;" class="">
                   ...
                   <%
                	if(request.getAttribute("infoType") != null){
	                    ...
	                    if(request.getAttribute("infoType").equals("true")){
	                    	...
	                    	out.println("<div class='alert alert-alert'>操作失败</div>");
	                    }
                	}
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <div class="portlet-body form">
                            <form action="StudentManagementServlet?action=edit" method="post" class="form-horizontal">
                                <div class="control-group">
                                    <label class="control-label" for="studentId">学生ID</label>

                                    <div class="controls">
                                        <input class="m-wrap medium" type="text" name="studentId" id="studentId"
                                               placeholder="Student ID" value='<%=student.getStudentId() %>' readonly/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="studentName">学生姓名</label>
                                    <div class="controls">
                                        <input class="m-wrap medium" type="text" name="studentName" id="studentName"
                                               placeholder="Student Name" value='<%=student.getName() %>'/>
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <%
									...
									<div class="control-group">
										<label class="control-label" for="department">学院</label>
										<div class="controls">
											<select class="small m-wrap" tabindex="1" name="departmentId"  onchange="SelectDepartment(this)">
											   <option>请选择学院</option>
												<%
												//得到一个用于循环显示的迭代器
                                 ...
                                 <div class="control-group">
										...
										<div class="controls">
											<select name="majorId" class="small m-wrap" tabindex="1" id="major">
												<option >请选择专业</option >
											</select>
										</div>
									</div>
                                ...
                                <div class="control-group">
                                    <label class="control-label" for="startTime">入学时间</label>
                                    <div class="controls">
                                        <input class="m-wrap medium" type="text" name="startTime" id="startTime"
                                               placeholder="StartTime"/>
                                    </div>
                                </div>
                                <div class="form-actions">
                                    <button class="btn  green" type="submit" name="save" value="save"><i class="icon-ok"></i>提交</button>
                                </div>
                            </form>
                        </div>
                    </div>
...
<!-- END CONTAINER -->
<script src="Style/js/addStudent.js"></script>
...
<!-- END JAVASCRIPTS -->
<script>
		function SelectDepartment(oSelect) {

			var departmentId = oSelect.value;
			if (departmentId != null && departmentId != 0) {

				var address = "StudentManagementServlet?action=getMajor&departmentId=" + departmentId;
				ajax(address,function(resText){
					...
					if(info){
						...
						var majorList = result.majorList;
						if(majorList == ""){
							//学院为空
							$("#major option").remove();
							$("#major").append("<option value='0'>无专业</option>");
							alert("该学院没有专业");
						}
						else{
							...
							for(var majorIndex in majorList){
								$("#major").append("<option value='" + majorList[majorIndex].majorId + "'>"+majorList[majorIndex].name+"</option>");
