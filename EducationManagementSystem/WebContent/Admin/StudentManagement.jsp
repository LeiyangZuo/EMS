			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<%
							//把后台传递过来的数据提取出来，并且显示												
								ArrayList<StudentModel> studentList = (ArrayList<StudentModel>)request.getAttribute("studentList");																																																																																													
							if(studentList.isEmpty()){
						%>
						<div class="alert">没有学生</div>
						<%
							}
		                         else{
			                         //有管理员信息，则显示这些信息
                             ...
                             //把AdminModel中得值显示出来
								...
								<tr>
									...
									<td><a class="btn mini purple"
										href="StudentManagementServlet?action=edit&studentId=<%=student.getStudentId()%>">
										<i class="icon-edit"></i> 编辑</a>
									</td>
									<td><a class="btn mini black"
										href="StudentManagementServlet?action=delete&studentId=<%=student.getStudentId()%>">
