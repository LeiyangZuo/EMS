                    ...
                    <div class="row-fluid">
                        <div class="span12">
							...
							<%
								...
								DepartmentModel department = (DepartmentModel)request.getAttribute("departmentModel");
								
							%>

                            <div class="portlet-body form">
                                <form action="CollegeManagementServlet?action=editdepartment" method="post" class="form-horizontal">
                                    <div class="control-group">
                                        <label class="control-label" for="departmentId">学院ID</label>
                                        <div class="controls">
                                            <input class="m-wrap medium" type = "text" name ="departmentId" id="departmentId"  value='<%=department.getDepartmentId() %>' readonly/>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label" for="name">学院名称</label>
                                        <div class="controls">
                                            <input class="m-wrap medium" type = "text" name ="name" id="name" placeholder="Department Name" value='<%=department.getName() %>' />
                                        </div>
                                    </div>
                                    <div class="form-actions">
                                        <button class="btn  yellow" type = "submit" name="save" value="save"><i class="icon-ok"></i>提交</button>
                                    </div>
                                </form>
                            </div>
                        </div>
