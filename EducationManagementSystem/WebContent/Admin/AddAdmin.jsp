...
<div class="page-container row-fluid">
    ...
    <div class="page-sidebar nav-collapse collapse">
        ...
        <ul>
            <li class="active has-sub">
                ...
                <ul class="sub">
                    <li class="active"><a href="AdminServlet?action=add">添加管理员</a></li>
						...
						<%
							if (request.getAttribute("infoType") != null) {
								...
								if (request.getAttribute("infoType").equals("true")) {
									...
									out.println("<div class='alert alert-alert'>添加失败</div>");
								}
							}
						%>
							...
							<div class="portlet-body form">
								<form action="AdminServlet?action=add" method="post"
									...
									<div class="control-group">
										...
										<div class="controls">
											<input class="m-wrap medium" type="text" name="adminId"
												id="adminId" placeholder="Admin ID" />
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input class="m-wrap medium" type="password" name="password"
									...
									<div class="control-group">
										...
										<div class="controls">
											<label class="checkbox line">
												<div class="checker">
													<span><input style="opacity: 0;" type="checkbox"
														id="isSuper" name="isSuper" /> </span>
												</div> 是超级管理员</label>
										</div>
									</div>
									<div class="form-actions">
										<button class="btn  red" type="submit" name="save"
											value="save">
	...
	<!-- END CONTAINER -->
	<script src="Style/js/addAdmin.js"></script>
