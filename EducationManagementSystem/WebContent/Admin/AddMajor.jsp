        ...
        <ul>
            ...
            <li class="active has-sub">
                ...
                <ul class="sub">
                    ...
                    <li class="active"><a href="CollegeManagementServlet?action=addmajor">添加专业</a></li>
					...
					<div class="row-fluid">
						<div class="span12">
							...
							<div class="portlet-body form">
								...
								<form action="CollegeManagementServlet?action=addmajor"
									...
									<div class="control-group">
										...
										<div class="controls">
											<input class="m-wrap medium" type="text" name="name"
												id="name" placeholder="Major Name" />
										</div>
									</div>
									...
									<div class="form-actions">
										<button class="btn  blue" type="submit" name="save"
											value="save">
