            ...
            <div class="row-fluid">
                ...
                <div class="span12">
                    ...
                    <%
                    	...
                    	TeacherModel teacher = (TeacherModel)request.getAttribute("teacherModel");
                     %>
                    
                    <div class="portlet-body form">
                        <form action="TeacherManagementServlet?action=edit" method="post" class="form-horizontal">
                            <div class="control-group">
                                <label class="control-label" for="teacherId">教师ID</label>

                                <div class="controls">
                                    <input class="m-wrap medium" type="text" name="teacherId" id="teacherId"
                                           placeholder="Teacher ID" value='<%=teacher.getTeacherId() %>' readonly/>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input class="m-wrap medium" type="text" name="teacherName" id="teacherName"
                                           placeholder="Teacher Name" value='<%=teacher.getName() %>'/>
                                </div>
                            </div>
                            <div class="control-group">
