		...
		<div class="page-sidebar nav-collapse collapse">
			...
			<ul>
				<li><a href="StudentServlet?action=studentinfo"> <i
						class="icon-user"></i> 个人信息查询 </a></li>
				<li><a href="StudentServlet?action=newslist"> <i
						class="icon-comments"></i> 消息查看 </a></li>
				<li class="active"><a href="StudentServlet?action=scorelist">
						<i class="icon-font"></i> 成绩查询 </a></li>
				<li><a href="StudentServlet?action=courselist"> <i
						class="icon-list-alt"></i> 课表查询 </a></li>
				<li><a href="StudentServlet?action=selectedcourselist"> <i class="icon-table"></i> 网上选课 </a></li>
							...
							<table class="table-bordered table table-advance table-striped table-hover">
								...
								<tbody>
									...
									<tr>
										...
										<td><%=course.getName()%></td>
										<td><%=teacher.getName() %></td>
										<td><%=compulsoryCourse.getScore()%></td>
...
<script>
		function SelectTerm(oSelect) {
			...
			if (term != null && term != 0) {
				...
				var address = "StudentServlet?action=scorelist&term=" + term;
