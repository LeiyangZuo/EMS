...
<title>Student Selected Courses</title>
</head>
	...
	<div class="page-container row-fluid">
		...
		<div class="page-sidebar nav-collapse collapse">
			...
			<ul>
				...
				<li class="active"><a href="StudentServlet?action=selectedcourselist"> <i
						...
						<%
							...
							if (infoType != null) {
								if (infoType.equals("true")) {
								    ...
								    out.println("<div class='alert alert-warning'>该课程已经添加过了，请选择其他课程</div>");
								}
							...
							<tbody>
								...
								<%
									...
									<td><a class="btn mini red"
										href="StudentServlet?action=addselectedcourse&courseId=<%=course.getCourseId()%>">
										<i class="icon-trash"></i> 添加</a>
									</td>
									</tr>
									<% 
											}
