...
<title>Apply to Stop a Course</title>
</head>
	...
	<div class="page-container row-fluid">
		...
		<div class="page-sidebar nav-collapse collapse">
			...
			<ul>
				...
				<li class="active"><a href="TeacherServlet?action=stopcourselist"> <i
						...
						<%
							String infoType = (String) request.getAttribute("infoType");
											if (infoType != null) {
												...
												} if(infoType.equals("false")) {
													out.println("<div class='alert alert-danger'>操作失败</div>");
												}if(infoType.equals("cannot")){
												   out.println("<div class='alert alert-warning'>改停课申请已经在审核中，请耐心等待！");
												}
											}
						%>
					</div>
							...
							<tbody>
								...
								<tr>
									...
									<td><a class="btn purple mini"
										onclick="AlartCourse('<%=Course.getCourseId()%>')"> <i
											class="icon-edit"></i> 申请停课</a></td>
								</tr>
								<%
									}
								%>
...
<![endif]-->
	...
	<script type="text/javascript">
		function AlartCourse(CourseId) {

			var address = "TeacherServlet?action=stopcourse&courseId="
					+ CourseId;

			var info = prompt("请输入停课的周数");
			var info2 = prompt("请输入补课的周数");

			if ((info == null || info == "") || (info2 == null || info2 == "")) {

				return;
			} else {

				address += "&stopWeek=" + info + "&addWeek=" + info2;
