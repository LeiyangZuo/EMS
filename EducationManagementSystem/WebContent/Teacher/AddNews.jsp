    ...
    <div class="page-sidebar nav-collapse collapse">
        ...
        <ul>
           <li><a href="TeacherServlet?action=courselist"> <i
                ...
                <ul class="sub">
                    <li class="active"><a href="TeacherServlet?action=addnews">添加消息</a></li>
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            ...
                            <div class="portlet-body form">
                                <form action="TeacherServlet?action=addnews" method="post" class="form-horizontal">
                                    <div class="control-group">
                                        <label class="control-label" for="newsTitle">标题</label>
                                        <div class="controls">
                                            <input class="m-wrap medium" type = "text" name ="newsTitle" id="newsTitle" placeholder="News Title"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <textarea class="span6 m-wrap" rows=5 name ="newsContext" id="newsContext"></textarea>
                                        </div>
                                    </div>
