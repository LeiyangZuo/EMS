				...
				<div class="row-fluid">
					<div class="span12">
							...
							<tbody>
								...
								<tr>
									<td><a
										href="NewsServlet?action=details&newsId=<%=news.getNewsId()%>"><%=news.getTitle()%></a>
									</td>
									<td><a class="btn mini purple"
										href="NewsServlet?action=edit&newsId=<%=news.getNewsId()%>">
										<i class="icon-edit"></i> 编辑</a>
									</td>
									<td><a class="btn mini black"
										href="NewsServlet?action=delete&newsId=<%=news.getNewsId()%>">
